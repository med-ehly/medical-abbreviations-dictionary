...
fetch("data.json")
  ...
  .then(data => {
    ...
    const categoryFilterTitle = document.createElement("h2");
    categoryFilterTitle.textContent = "Catégories";
    categoryFilterContainer.appendChild(categoryFilterTitle);
    ...
    document.body.insertBefore(categoryFilterContainer, resultsList);

    // Générer les boutons de filtre pour les types de termes
    const typeFilterContainer = document.createElement("div");
    typeFilterContainer.classList.add("type-filter");
    const typeFilterTitle = document.createElement("h2");
    typeFilterTitle.textContent = "Types";
    typeFilterContainer.appendChild(typeFilterTitle);
    ...
    document.body.insertBefore(typeFilterContainer, resultsList);
  })
  .catch(error => {
