...
function handleMouseEnter(event) {
  ...
  const top = rowRect.bottom + window.scrollY + 0.5;
  const left = rowRect.right + window.scrollX + 0.5; // Ajustez la valeur 10 selon votre préférence pour l'espace entre l'élément et le popover
