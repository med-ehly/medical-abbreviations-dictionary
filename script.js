...
function handleMouseEnter(event) {
  ...
  const top = rowRect.bottom + window.scrollY + 2;
  const left = rowRect.right + window.scrollX + 2; // Ajustez la valeur 10 selon votre préférence pour l'espace entre l'élément et le popover
